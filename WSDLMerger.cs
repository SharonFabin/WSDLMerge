...
internal static class WSDLMerger
{
    ...
    )
    {
        ...
        foreach (XmlNode node in imports)
        {
            ...
            if (schemas.ContainsKey(schemasKey))
                continue;
            ...
            XmlElement newSchema =
                wsdl.ImportNode(schemaDocument.DocumentElement, true) as XmlElement;
    ...
    private static void ProcessSchemaIncludes(
        XmlNamespaceManager manager,
        string filename,
        XmlDocument wsdl,
        XmlElement newSchema
    ...
    /// <param name="newSchema"></param>
    private static void ProcessSchemaInnerImports(
        XmlNamespaceManager manager,
        int level,
        XmlElement newSchema
    )
